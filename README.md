...
Nguyên tắc chung
Stack: CodeIgniter 4, PHP 8.3, MySQL, AdminLTE 4 (Bootstrap 5), SSR + JSON cho Ajax/Select2.
...
Cài/khởi tạo CI4 (PHP 8.3), .env, timezone, locale vi.
...
Entities PHP 8.3 (constructor promotion, strict types).
Gate xác nhận:
